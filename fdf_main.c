...
/*   Updated: 2025/03/04 16:47:04 by lemarino         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int ac, char **av)
{
	...
	img.width = get_width(av[1]);// if fallisce?
	img.map = cartography(av[1], 1, &img);// if fallisce?
	img.colmap = cartography(av[1], 2, &img);// if fallisce?
	// ##protezione da malloc falliti
	draw(&img);
